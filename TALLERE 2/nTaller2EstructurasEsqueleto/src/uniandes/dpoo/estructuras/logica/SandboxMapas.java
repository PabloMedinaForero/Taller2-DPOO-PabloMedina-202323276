...
public class SandboxMapas
{
    ...
    public List<String> getValoresComoLista( )
    {
    	...
    	Iterator iterador = values.iterator();
    ...
    public List<String> getLlavesComoListaInvertida( )
    {
    	...
    	Collections.sort(listaNueva, Comparator.reverseOrder());
        return listaNueva;
    }
    ...
    public String getPrimera( )
    {
        ...
        List<String> clavesOrdenadas = new ArrayList<>(mapaCadenas.keySet());
        Collections.sort(clavesOrdenadas); 

        return clavesOrdenadas.get(0);
    }
